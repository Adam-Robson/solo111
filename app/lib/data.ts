...
export const navigationLinks: NavigationLink[] = [
  ...
  { name: "projects", path: "/projects", title: "View a list of my projects!" },
  { name: "contact", path: "/contact", title: "Get in touch with me!" },
  { name: "more", path: "/more", title: "More about me this way!" },
];
