...
export const projects: ProjectTypes[] = [
  {
    id: 1,
    title: "Pantry Pal",
    description: `Pantry Pal is a mobile responsive web-application that locates food pantries anywhere in the US.`,
  ...
  },
  {
    id: 3,
    title: "Collabo",
    description: `The "Open Source Song Project Platform" Collabo is an innovative collaborative platform that enables musicians from all corners of the globe to create music together remotely.`,
