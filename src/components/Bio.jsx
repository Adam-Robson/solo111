...
export default function Bio() {
  ...
  return (
    <section className="max-w-full w-11/12 mx-auto fadein px-6">
      ...
      <div className="max-w-xs w-full mx-auto p-2 flex flex-col lg:flex-row lg:justify-center space-y-4 lg:space-y-0 lg:space-x-4">
        <BioImage className="max-w-xs border border-cyan-300" imageUrl={or} text="I am a software engineer and artist living in the beautiful pacific northwest." />
        <BioImage className="max-w-xs" imageUrl={globe} text={
        ...
        <BioImage className="max-w-xs" imageUrl={adam} text="I enjoy working with Postgres, Express, React and Node." />
      </div>
    </section>
  );
}
