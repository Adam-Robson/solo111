  ...
  return (
    <>
      <section className="max-w-full w-10/12 mx-auto fadein px-6">
        <Link className="absolute top-6 right-6 subpixel-antialiased homelink" to="/">home</Link>
        <h1 className="text-7xl sm:text-8xl font-light subpixel-antialiased mt-12">oh no!</h1>
        <h2 className="subtitle text-center text2xl sm:text-3xl md:text-4xl subpixel-antialiased mt-12">
          Page Not Found!
        </h2>
