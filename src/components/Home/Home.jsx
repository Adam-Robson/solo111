    ...
    <>
      <section id="home-section" className="text-center md:min-h-full" style={ { color: `var(--feldgrau)` } }>
        <div className="text-center">
          <h1 className="text-center text-5xl my-24 font-extralight tracking-wider md:text-7xl subpixel-antialiased">
          ...
          <ul className="flex justify-evenly items-end min-w-full absolute bottom-0 mb-24 subpixel-antialiased">
