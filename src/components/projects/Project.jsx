...
export default function Project({ title, description, link, features }) {
  ...
  return (
    <article
      style={{ border: 'var(--dogwood) 4px double' }}
      className="project-border my-12 p-4 border rounded-lg border-pink-300 hover:border-cyan-700 hover:shadow-md transition duration-300 ease-in-out"
