export const writings = [
  ...
  },
  {
    ...
    name: 'tuesday',
    title: 'tuesday',
    text: ['a fickle freckled fawn, ', 'treated dawn, ', 'with a yawn. ', 'as tears of newly wake, ', 'seeped through, ', 'her eyeballs drape. ', 'swaying back and forth, ', 'between shadows senses dreamed, ', 'she gleamed, ', 'disguising happenstance, ', 'with people that shed seen. ', 'the soundtrack was, ', 'their laughing rhythm, ', 'floating words like fiends, ', 'tickling her smile strings, ', 'a euphoric sleepy lean. ']
  },
  {
    id: '3',
    name: 'earth',
  ...
  },
  {
    ...
    name: 'between',
    title: 'in between',
    text: ['while here i hear a tongue, ', 'feel the trees against the sun. ', 'in the breeze hear spirits breathe. ', 'the world weaves in gravity. ', 'where many can not taste, ', 'i find i fill up to my face. ', 'see the thoughts, ', 'just like the clouds, ', 'will soon reveal, ', 'and sooner shroud. ', 'where even knowing, ', 'becomes confusing, ', 'and soon enough, ', 'becomes amusing, ', 'pinch my skin, ', 'and i will budge. ', 'i am in between, ', 'a grin and nudge.']
  },
  {
    id: '6',
    name: 'water',
